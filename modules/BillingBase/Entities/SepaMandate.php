...
class SepaMandate extends \BaseModel
{
    ...
    public static function rules($id = null)
    {
        return [
            ...
            'sepa_bic' 			=> 'bic|regex:/[A-Z]{6,6}[A-Z2-9][A-NP-Z0-9]([A-Z0-9]{3,3}){0,3}/',			// see SepaMandateController@prep_rules, Sparkasse/S-Firm regex from error message of sepa-xml upload
