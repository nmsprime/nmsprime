...
class BillingBaseController extends \BaseController {
	...
	public function view_form_fields($model = null)
	{
		...
		return [
			...
			array('form_type' => 'text', 'name' => 'mandate_ref_template', 'description' => 'Mandate Reference', 'help' => trans('helper.BillingBase_MandateRef').$cols , 'options' => ['placeholder' => 'e.g.: String - {number}']), 
