...
<div class="widget widget-stats bg-aqua-darker">
    ...
    <div class="stats-info d-flex">
      ...
      {!! HTML::decode (HTML::link('https://devel.roetzer-engineering.com/confluence/display/NMS/Billing',
      ...
      {!! HTML::decode (HTML::link('https://youtu.be/QDsxx6oe4mw',
  			'<span class="btn btn-dark p-10 m-5 m-r-10 text-center">
      ...
      {!! HTML::decode (HTML::link('https://devel.roetzer-engineering.com/confluence/display/nmsprimeforum/Billing',
  			'<span class="btn btn-dark p-10 m-5 m-r-10 text-center">
