...
return [
    ...
    'invoice' => [
        'invalidRealtyHousenr' => 'The realty with ID :id has an invalid formatted house number (:nr) and can therefor not be added to the object list of contract :contractnr.',
    ],
    'realty' => [
