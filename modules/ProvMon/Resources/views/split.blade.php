...
<div class="row">
	...
	<div class="col-md-5 ui-sortable">
		...
		@include ('bootstrap.panel', array ('content' => 'content_ping', 'view_header' => '<ul class="nav nav-pills" id="ping-tab">
		...
		@include ('bootstrap.panel', array ('content' => 'content_log', 'view_header' => '<ul class="nav nav-pills" id="loglease">
