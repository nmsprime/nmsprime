...
class CdrController extends \BaseController {
	...
	public function view_form_fields($model = null)
	{
		...
		return array(
			...
			array('form_type' => 'text', 'name' => 'b_mos_f1_min_mult10', 'description' => 'min. MOS 50ms', 'help' => trans('helper.a_mos_f1_min_mult10'), 'eval' => '$var/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_f2_min_mult10', 'description' => 'min. MOS 200ms', 'help' => trans('helper.a_mos_f2_min_mult10'), 'eval' => '$var/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_adapt_min_mult10', 'description' => 'min. MOS adaptive 500ms', 'help' => trans('helper.a_mos_adapt_min_mult10'), 'eval' => '$var/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_f1_mult10', 'description' => 'avg. MOS 50ms', 'help' => trans('helper.a_mos_f1_mult10'),   'eval' => '$var/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_f2_mult10', 'description' => 'avg. MOS 200ms', 'help' => trans('helper.a_mos_f2_mult10') , 'eval' => '$var/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_adapt_mult10', 'description' => 'avg. MOS adaptive 500ms', 'help' => trans('helper.a_mos_adapt_mult10') , 'eval' => '$var/10', 'options' => ['readonly']),
