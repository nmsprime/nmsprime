...
class CdrController extends \BaseController {
	...
	public function view_form_fields($model = null)
	{
		...
		return array(
			...
			array('form_type' => 'text', 'name' => 'a_sl9', 'description' => '9 losses in a row', 'help' => trans('helper.a_sl9') , 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'a_d50', 'description' => 'PDV 50ms - 70ms', 'help' => trans('helper.a_d50') , 'options' => ['readonly']),
			...
			array('form_type' => 'text', 'name' => 'a_d300', 'description' => 'PDV >300 ms', 'help' => trans('helper.a_d300') , 'options' => ['readonly'], 'space' => '1'),
			/* monitoring quality indicators caller -> callee */
			array('form_type' => 'text', 'name' => 'called', 'description' => 'Callee (-> Caller)', 'help' => trans('helper.called'), 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'called_domain', 'description' => '@Domain', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_f1_min_mult10', 'description' => 'min. MOS 50ms', 'help' => trans('helper.a_mos_f1_min_mult10'), 'eval' => '$name/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_f2_min_mult10', 'description' => 'min. MOS 200ms', 'help' => trans('helper.a_mos_f2_min_mult10'), 'eval' => '$name/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_adapt_min_mult10', 'description' => 'min. MOS adaptive 500ms', 'help' => trans('helper.a_mos_adapt_min_mult10'), 'eval' => '$name/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_f1_mult10', 'description' => 'avg. MOS 50ms', 'help' => trans('helper.a_mos_f1_mult10'),   'eval' => '$name/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_f2_mult10', 'description' => 'avg. MOS 200ms', 'help' => trans('helper.a_mos_f2_mult10') , 'eval' => '$name/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_mos_adapt_mult10', 'description' => 'avg. MOS adaptive 500ms', 'help' => trans('helper.a_mos_adapt_mult10') , 'eval' => '$name/10', 'options' => ['readonly']),
			...
			array('form_type' => 'text', 'name' => 'b_packet_loss_perc_mult1000', 'description' => 'Packet loss/%', 'eval' => '$name/1000', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_delay_avg_mult100', 'description' => 'avg. Delay/ms', 'eval' => '$name/100', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_avgjitter_mult10', 'description' => 'avg. Jitter/ms', 'eval' => '$name/10', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_maxjitter', 'description' => 'max. Jitter/ms', 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_sl1', 'description' => '1 loss in a row', 'help' => trans('helper.a_sl1') , 'options' => ['readonly']),
			...
			array('form_type' => 'text', 'name' => 'b_sl9', 'description' => '9 losses in a row', trans('helper.a_sl9'), 'options' => ['readonly']),
			array('form_type' => 'text', 'name' => 'b_d50', 'description' => 'PDV 50ms - 70ms', 'help' => trans('helper.a_d50') , 'options' => ['readonly']),
			...
			array('form_type' => 'text', 'name' => 'b_d300', 'description' => 'PDV >300 ms', 'help' => trans('helper.a_d300') , 'options' => ['readonly'])
		);
	}
