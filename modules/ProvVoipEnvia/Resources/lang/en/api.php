...
return [
	...
	"contract_gettariff" => "Get envia TEL sales tariff",
	"contract_gettariff_help" => "Gets the current tariff for this contract. If a tariff change is in progress the old tariff will be shown.",
	"contract_getvariation" => "Get envia TEL purchase tariff",
	"contract_getvariation_help" => "Gets the current variation for this contract. If a variation change is in progress the old variation will be shown.",
