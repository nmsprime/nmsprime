...
return [
	...
	"contract_gettariff" => "Hole den Verkaufstarif für diesen envia-TEL-Vertrag",
	"contract_gettariff_help" => "Diese Methode fragt den aktuellen End-Sprachtarif für den Anschluss ab. Sollte sich aktuell eine Änderung des Sprachtarifs in Bearbeitung befinden, gibt die Methode noch den alten Tarif zurück.",
	"contract_getvariation" => "Hole den Einkaufstarif für diesen envia-TEL-Vertrag",
	"contract_getvariation_help" => "Diese Methode ermittelt die Produktvariante eines Anschlusses. Sollte sich aktuell ein Variantenwechsel in Bearbeitung befinden, gibt die Methode noch die alte Variante zurück.",
